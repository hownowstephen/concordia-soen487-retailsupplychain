 ...
 * 
 */
@WebService(name = "Manufacturer3", targetNamespace = "http://manufacturer.supplychain.soen487.org/")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface Manufacturer3 {
    ...
    @Action(input = "http://manufacturer.supplychain.soen487.org/Manufacturer3/getProductInfoRequest", output = "http://manufacturer.supplychain.soen487.org/Manufacturer3/getProductInfoResponse")
    ...
    @Action(input = "http://manufacturer.supplychain.soen487.org/Manufacturer3/getProductQuantityRequest", output = "http://manufacturer.supplychain.soen487.org/Manufacturer3/getProductQuantityResponse")
    ...
    @Action(input = "http://manufacturer.supplychain.soen487.org/Manufacturer3/receivePaymentRequest", output = "http://manufacturer.supplychain.soen487.org/Manufacturer3/receivePaymentResponse")
    ...
    @Action(input = "http://manufacturer.supplychain.soen487.org/Manufacturer3/processPurchaseOrderRequest", output = "http://manufacturer.supplychain.soen487.org/Manufacturer3/processPurchaseOrderResponse")
