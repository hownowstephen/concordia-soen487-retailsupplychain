 ...
 * 
 */
@WebService(name = "Manufacturer", targetNamespace = "http://manufacturer.supplychain.soen487.org/")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface Manufacturer {
    ...
    @Action(input = "http://manufacturer.supplychain.soen487.org/Manufacturer/getProductInfoRequest", output = "http://manufacturer.supplychain.soen487.org/Manufacturer/getProductInfoResponse")
    ...
    @Action(input = "http://manufacturer.supplychain.soen487.org/Manufacturer/getProductQuantityRequest", output = "http://manufacturer.supplychain.soen487.org/Manufacturer/getProductQuantityResponse")
    ...
    @Action(input = "http://manufacturer.supplychain.soen487.org/Manufacturer/receivePaymentRequest", output = "http://manufacturer.supplychain.soen487.org/Manufacturer/receivePaymentResponse")
    ...
    @Action(input = "http://manufacturer.supplychain.soen487.org/Manufacturer/processPurchaseOrderRequest", output = "http://manufacturer.supplychain.soen487.org/Manufacturer/processPurchaseOrderResponse")
